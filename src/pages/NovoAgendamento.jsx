...
import { ChakraProvider, Checkbox, Badge, Tag, HStack, Box, VStack, useToast, Text, Image, Card, Button, Flex, Spinner, Input, Stepper, Step, StepIndicator, StepTitle, StepDescription, StepStatus, StepIcon, StepNumber, StepSeparator, useBreakpointValue } from '@chakra-ui/react';
...
const NovoAgendamento = () => {
    ...
    const collaboratorDescriptions = {
        23: (
            <>
                <Tag colorScheme="blue">Corte</Tag>
                <Tag colorScheme="green" ml={2}>Infantil</Tag>
                <Tag colorScheme="purple" ml={2}>Estética</Tag>
                <Tag colorScheme="yellow" ml={2}>Visagismo</Tag>
                <Tag colorScheme="red" ml={2}>barbaterapia</Tag>
            </>
        ),
        24: (
            <>
                <Tag colorScheme="blue">Corte</Tag>
                <Tag colorScheme="green" ml={2}>FreeStyle</Tag>
                <Tag colorScheme="purple" ml={2}>Estética</Tag>
                <Tag colorScheme="yellow" ml={2}>Visagismo</Tag>
                <Tag colorScheme="red" ml={2}>barbaterapia</Tag>
            </>
                                ...
                                >
                                    ...
                                    <Card bg='#CECECECE' p={3}>
                                        <Flex justifyContent="center" w="100%">
                                            <Card w={{ base: '90%', md: '300px' }} bg='#FFFF' p={5} position="relative">
                                                <Badge
                                                    colorScheme="yellow"
                                                    mb={0}
                                                    borderRadius="full"
                                    ...
                                    <Card bg='#CECECECE' p={3}>
                                        <Flex justifyContent="center" w="100%">
                                            <Card w={{ base: '90%', md: '300px' }} bg='#FFFF' p={5}>
